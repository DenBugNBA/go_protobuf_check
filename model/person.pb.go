...
func (x *PersonOptional) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PersonOptional) ProtoMessage() {}

func (x *PersonOptional) ProtoReflect() protoreflect.Message {
	mi := &file_proto_person_proto_msgTypes[0]
...
// Deprecated: Use PersonOptional.ProtoReflect.Descriptor instead.
func (*PersonOptional) Descriptor() ([]byte, []int) {
	return file_proto_person_proto_rawDescGZIP(), []int{0}
}

func (x *PersonOptional) GetName() string {
	if x != nil && x.Name != nil {
		return *x.Name
	}
	return ""
...
func (x *PersonOptional) GetId() int32 {
	if x != nil && x.Id != nil {
		return *x.Id
	}
	return 0
...
func (x *PersonOptional) GetEmail() string {
...
var file_proto_person_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x22, 0x73,
	0x0a, 0x0e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x48, 0x01, 0x52, 0x02, 0x69, 0x64, 0x88, 0x01, 0x01, 0x12, 0x19,
	0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x48, 0x02, 0x52,
	0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x88, 0x01, 0x01, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x6e, 0x61,
	0x6d, 0x65, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69, 0x64, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x6d,
	0x61, 0x69, 0x6c, 0x22, 0x42, 0x0a, 0x06, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x12, 0x12, 0x0a,
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x6d, 0x6f, 0x64, 0x65,
...
var file_proto_person_proto_goTypes = []interface{}{
	(*PersonOptional)(nil), // 0: protobuf.PersonOptional
...
func file_proto_person_proto_init() {
	...
	file_proto_person_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
